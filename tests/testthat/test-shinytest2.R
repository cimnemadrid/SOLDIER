...
test_that("{shinytest2} recording: test_scatter_plot_time_series", {
  ...
  app$set_window_size(height = 943, width = 1577)
  Sys.sleep(0.5)
  app$set_inputs(color_scat = "Year")
  Sys.sleep(0.5)
  app$set_window_size(height = 943, width = 1577)
  Sys.sleep(0.5)
  app$click("refresh6")
...
test_that("{shinytest2} recording: test_scatter_plot_4d_time_series", {
  ...
  app$set_window_size(height = 943, width = 1577)
  Sys.sleep(0.5)
  app$set_inputs(color_scat4d = "Rainfall")
  Sys.sleep(0.5)
  app$set_window_size(height = 943, width = 1577)
  Sys.sleep(0.5)
  app$click("refresh3")
...
test_that("{shinytest2} recording: test_scatter_plot_4d_other_data", {
  ...
  app$set_window_size(height = 943, width = 1577)
  Sys.sleep(0.5)
  app$set_inputs(color_scat4d = "cyl")
  Sys.sleep(0.5)
  app$set_window_size(height = 943, width = 1577)
  Sys.sleep(0.5)
  app$click("refresh3")
...
test_that("{shinytest2} recording: test_convex_hull", {
  ...
  app$set_window_size(height = 943, width = 1577)
  Sys.sleep(0.5)
  app$set_inputs(color_scat = "Temp007")
  Sys.sleep(0.5)
  app$set_window_size(height = 943, width = 1577)
  Sys.sleep(0.5)
  app$click("refresh6")
...
test_that("{shinytest2} recording: test_confidence_interval", {
  app <- AppDriver$new(variant = platform_variant(), name = "test_confidence_interval", 
      height = 943, width = 1577)
  app$set_inputs(data_type = "1")
  Sys.sleep(0.5)
  app$set_window_size(height = 943, width = 1577)
  ...
  app$set_window_size(height = 943, width = 1577)
  Sys.sleep(0.5)
  app$set_inputs(confidence_interval = TRUE)
  Sys.sleep(0.5)
  app$set_window_size(height = 943, width = 1577)
  Sys.sleep(0.5)
  app$click("refresh_pred_data")
